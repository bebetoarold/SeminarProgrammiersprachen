            ...
            if(isValidPath(path) && path != ""){
                ...
                if(exists(path)){
                    ...
                    if(isDir(path)){
                        ...
                        foreach(string entry; dirEntries(path, SpanMode.breadth)){  //Spans the directory in depth-first pre-order, i.e. the content of any subdirectory is spanned right after that subdirectory itself. 
                            writeln("Entry: ", entry);
